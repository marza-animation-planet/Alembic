...
public:
    ...
    getBBoxPlaceHolderSample(double seconds, const MMatrix &rootMatrix);

    // Retrieve the current sample from property cache
    virtual boost::shared_ptr<const ShapeSample>
    getSample(double seconds, const MMatrix &rootMatrix) = 0;
...
public:
    ...
    // Retrieve the current sample from property cache
    virtual boost::shared_ptr<const ShapeSample>
    getSample(double seconds, const MMatrix &rootMatrix);
...
public:
    ...
    virtual MBoundingBox getBoundingBoxNTR() const = 0;
...
public:
    ...
    virtual MBoundingBox getBoundingBoxNTR() const;
...
private:
    ...
    std::map<double, MMatrix>         fMatrices;
};
