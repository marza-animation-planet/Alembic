...
)
{
    ...
    view.pushName(0);
    {
        ...
        DrawWireframeState state(frustum, seconds, vboMode, fIgnoreTransforms, fIgnoreVisibility);
...
)
{
    ...
    view.pushName(0);
    {
        ...
        DrawShadedState state(frustum, seconds, vboMode, fIgnoreTransforms, fIgnoreVisibility);
...
)
{
    ...
    MBoundingBox boundingBox = BoundingBoxVisitor::boundingBox(rootNode, seconds, fIgnoreTransforms, fIgnoreVisibility);
