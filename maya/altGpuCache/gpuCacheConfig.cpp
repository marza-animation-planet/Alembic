...
const MString Config::kDisplayFilter = "altGpuCacheDisplayFilter";
...
Config::VP2OverrideAPI Config::vp2OverrideAPI()
{
    ...
    if (!initialized) {
        ...
        int allAutoValue = MGlobal::optionVarIntValue("altGpuCacheAllAuto", &existAllAuto);
        bool automatic = !existAllAuto || allAutoValue == 1;

        // Sync with option var (read user pref)
        syncIntOptionVar(automatic, "altGpuCacheVP2OverrideAPIAuto", "altGpuCacheVP2OverrideAPI", sDefaultVP2OverrideAPI, sVP2OverrideAPI);
...
void Config::refresh()
{
    ...
    int allAutoValue = MGlobal::optionVarIntValue("altGpuCacheAllAuto", &existAllAuto);
    if (!existAllAuto) {
        MGlobal::setOptionVarValue("altGpuCacheAllAuto", 1);
    }
    bool automatic = !existAllAuto || allAutoValue == 1;
    syncIntOptionVar(automatic, "altGpuCacheMaxVramAuto", "altGpuCacheMaxVram", sDefaultMaxVBOSize, sMaxVBOSize, 1024*1024);
    syncIntOptionVar(automatic, "altGpuCacheMaxNumOfBuffersAuto", "altGpuCacheMaxNumOfBuffers", sDefaultMaxVBOCount, sMaxVBOCount);
    syncIntOptionVar(automatic, "altGpuCacheMinVerticesPerShapeAuto", "altGpuCacheMinVerticesPerShape", sDefaultMinVertsForVBOs, sMinVertsForVBOs);
    syncBoolOptionVar(automatic, "altGpuCacheLowVramOperationAuto", "altGpuCacheLowMemMode", sDefaultUseVertexArrayWhenVRAMIsLow, sUseVertexArrayWhenVRAMIsLow, 2);

    syncBoolOptionVar(automatic, "altGpuCacheGlSelectionModeAuto", "altGpuCacheGlSelectionMode", sDefaultUseVertexArrayForGLPicking, sUseVertexArrayForGLPicking, 1);
    syncIntOptionVar(automatic, "altGpuCacheSelectionWireThresholdAuto", "altGpuCacheSelectionWireThreshold", sDefaultOpenGLPickingWireframeThreshold, sOpenGLPickingWireframeThreshold);
    syncIntOptionVar(automatic, "altGpuCacheSelectionSurfaceThresholdAuto", "altGpuCacheSelectionSurfaceThreshold", sDefaultOpenGLPickingSurfaceThreshold, sOpenGLPickingSurfaceThreshold);

    syncBoolOptionVar(automatic, "altGpuCacheDisableVertexArraysAuto", "altGpuCacheUseVertexArrays", sDefaultUseGLPrimitivesInsteadOfVA, sUseGLPrimitivesInsteadOfVA, 2);
    syncBoolOptionVar(automatic, "altGpuCacheTwoSidedLightingAuto", "altGpuCacheTwoSidedLightingMode", sDefaultEmulateTwoSidedLighting, sEmulateTwoSidedLighting, 2);
    syncBoolOptionVar(automatic, "altGpuCacheUvCoordinatesAuto", "altGpuCacheIgnoreUv", sDefaultIsIgnoringUVs, sIsIgnoringUVs, true);
    syncIntOptionVar(automatic, "altGpuCacheVP2OverrideAPIAuto", "altGpuCacheVP2OverrideAPI", sDefaultVP2OverrideAPI, sVP2OverrideAPI);
    syncBoolOptionVar(automatic, "altGpuCacheBackgroundReadingAuto", "altGpuCacheBackgroundReading", sDefaultBackgroundReading, sBackgroundReading, true);
    syncIntOptionVar(automatic, "altGpuCacheBackgroundReadingRefreshAuto", "altGpuCacheBackgroundReadingRefresh", sDefaultBackgroundReadingRefresh, sBackgroundReadingRefresh);
    syncBoolOptionVar(automatic, "altGpuCacheUseHardwareInsancingAuto", "altGpuCacheUseHardwareInstancing", sDefaultUseHardwareInstancing, sUseHardwareInstancing, true);
    syncIntOptionVar(automatic, "altGpuCacheHardwareInstancingThresholdAuto", "altGpuCacheHardwareInstancingThreshold", sDefaultHardwareInstancingThreshold, sHardwareInstancingThreshold);
}
