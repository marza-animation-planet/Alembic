...
namespace Strings
{
   ...
   AtString ignore_attributes("ignore_attributes");
   AtString attributes_evaluation_time("attributes_evaluation_time");
   AtString remove_attribute_prefices("remove_attribute_prefices");
   
   AtString compute_tangents_for_uvs("compute_tangents_for_uvs");
